        ...
        <div class="card card-sidebar-mobile">
            <ul class="nav nav-sidebar" data-nav-type="accordion">
                ...
                @if(Qs::userIsTeamSA())
                    ...
                    {{--Manage Topics--}}
                    <li class="nav-item">
                        <a href="{{ route('topics.index') }}" class="nav-link {{ in_array(Route::currentRouteName(), ['topics.index','topics.edit', 'topics.create']) ? 'active' : '' }}"><i class="icon-stack-text"></i> <span>Topics</span></a>
                    </li>
                @endif
