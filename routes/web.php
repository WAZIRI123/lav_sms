...
// Add this with your other routes, before the auth middleware group
...
Route::group(['middleware' => 'auth'], function () {
        ...
        Route::group(['prefix' => 'marks'], function(){
           ...
           // FOR teamSA
            ...
            Route::group(['middleware' => 'teamSAT'], function(){
                ...
                Route::get('manage/{exam}/{class}/{section}/{subject}/{topic}', 'MarkController@manage')->name('marks.manage');
    ...
    Route::group(['prefix' => 'ajax'], function() {
        ...
        Route::get('get_subject_topics/{subject_id}/{class_id?}', 'AjaxController@get_subject_topics')->name('ajax.get_subject_topics');
    });
